...
const SECRET_STORAGE_KEY = 'blog-audio-upload-secret'

export default function BlogAudioUploadPage() {
  ...
  return (
    <SectionContainer>
      <div className="space-y-6">
        <div>
          <PageTitle>Upload blog audio</PageTitle>
        ...
        <form
          ...
          onSubmit={async (event) => {
            ...
            setProgress(0)
            try {
              const pathname = `blog-audio/${file.name}`
              const newBlob = await upload(pathname, file, {
                access: 'public',
                handleUploadUrl: '/api/blog-audio/upload',
                multipart: true,
                onUploadProgress: (e) => setProgress(e.percentage ?? 0),
        ...
        >
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="Same value as BLOG_AUDIO_UPLOAD_SECRET"
              autoComplete="off"
              disabled={uploading}
        ...
        {blob && (
          <div className="rounded-xl border border-gray-200 bg-gray-50 p-6 dark:border-gray-700 dark:bg-gray-800/50">
            ...
            <p className="mt-3 text-xs text-gray-500 dark:text-gray-400">
              In your .mdx frontmatter add: <code>audioUrl: &apos;{blob.url}&apos;</code>
            </p>
          </div>
        )}
