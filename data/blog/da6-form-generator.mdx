...
While the core features are functional, there's always room to grow:
...
The application is currently in active development with core features functional. PDF generation and advanced templates are coming soon, making it even more powerful for unit administrators.
